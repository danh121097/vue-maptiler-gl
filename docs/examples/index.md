...
- `useCreateMapTiler()` - Map creation
- `useMapTiler()` - Map context access
...
Use `<GeolocateControls>`, add MapTiler's own controls to the map, and write a custom one.
...
```bash
git clone https://github.com/danh121097/vue-maptiler-gl
cd vue-maptiler-gl/examples
bun install
bun dev
```
...
- Build on top of `useMapTiler()` composable
...
- **Check**: Event name is correct (see MapTiler SDK docs)
...
- [GitHub Repository](https://github.com/danh121097/vue-maptiler-gl)
...
- Visit our [GitHub repository](https://github.com/danh121097/vue-maptiler-gl) for issues and discussions
