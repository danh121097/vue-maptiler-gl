...
Vue3 MapTiler GL provides comprehensive TypeScript support with well-defined types and interfaces for all components and composables.
...
```typescript
interface MapTilerActions extends CreateMapTilerActions {
...
Vue3 MapTiler GL re-exports all relevant MapTiler GL JS types for convenience:
...
For complete type definitions, refer to the [MapTiler GL JS documentation](https://docs.maptiler.com).
