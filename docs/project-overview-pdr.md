...
| **Testing**       | 241 tests across 35 files, with a coverage ratchet in CI                                                         |
...
- **Testing**: vitest, 241 tests across 35 files, with a coverage ratchet
...
| Tests          | 35 test files                                             | `bun run test`                                                       |
