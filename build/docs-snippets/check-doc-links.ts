 ...
 * navigation was. `/api/types#maptilermethods` was linked from the composables
...
const STALE_DOC_URLS: { prefix: string; replacement: string }[] = [
  {
    prefix: 'https://danh121097.github.io/vue-maptiler-gl',
    replacement: 'https://vue-maptiler-gl.pages.dev',
  },
];
