...
describe('checkLinks', () => {
  ...
  it('leaves an ordinary external link alone', () => {
    expect(problems('[MapTiler](https://maptiler.com/)')).toEqual([]);
  });
  ...
  it('reports a link to the documentation site this project dropped', () => {
    ...
    expect(
      problems(
        '[Docs](https://danh121097.github.io/vue-maptiler-gl/guide/installation)',
      ),
    ).toEqual([
      "error: link target 'https://danh121097.github.io/vue-maptiler-gl/guide/installation' " +
        'points at a documentation site this project no longer publishes; ' +
        'use https://vue-maptiler-gl.pages.dev',
    ]);
  });
});
