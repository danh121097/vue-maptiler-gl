...
import type { CircleLayerSpecification, Map } from '@maptiler/sdk';
import { withSetup } from '../test-utils';
import { MockMap } from './mock-maptiler';
...
class StyleSwapMap extends MockMap {
  ...
  /**
   * `map.setStyle(next)` on its default `diff: true` path: MapTiler diffs the
